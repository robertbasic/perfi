Feature: Transactions
    ...
    Scenario: A payment from an asset for an expense
        ...
        Then there should be a transaction that happened on "2017-03-12" for 1200 RSD between "Cash" asset account and "Groceries" expense account

    Scenario: A refund for an expense to an asset
        Given I have an asset account called "Cash"
        And I have an expense account called "Groceries"
        When I refund 200 RSD from the "Groceries" to "Cash" on "2017-03-12"
        Then there should be a transaction that happened on "today" for 200 RSD between "Groceries" expense account and "Cash" asset account
