...
class RefundableAccount
{
    ...
    public function isSatisfiedBy(Account $expenseAccount, Account $assetAccount)
    {
        return $this->expenseAccountSpecification->isSatisfiedBy($expenseAccount->type())
            && $this->assetAccountSpecification->isSatisfiedBy($assetAccount->type());
    }
}
